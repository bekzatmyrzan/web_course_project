...
@section('mainContent')
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 pl-md-5">
                    <h2 class="text-black">About SportQ</h2>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-2">
                    <img src="{{ asset('images/about_2.jpg')}}" alt="Image" class="img-fluid">
                </div>
    ...
    <div class="slide-one-item owl-carousel">
        <div class="bg-image center overlay" style="background-image: url('{{ asset('images/hero_bg_01.jpeg')}}')"></div>
        <div class="bg-image center overlay" style="background-image: url('{{ asset('images/hero_bg_02.jpg')}}')"></div>
        <div class="bg-image center overlay" style="background-image: url('{{ asset('images/hero_bg_03.jpg')}}')"></div>
        <div class="bg-image center overlay" style="background-image: url('{{ asset('images/img_01.jpg')}}')"></div>
    </div>
